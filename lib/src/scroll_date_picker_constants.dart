...
extension DatePickerLocaleExtension on DatePickerLocale {
  ...
  DatePickerLocaleOptions get localeOptions {
    switch (this) {
      case DatePickerLocale.ko_kr:
        return DatePickerLocaleOptions(yearLabel: "년", monthLabel: "월", dayLabel: "일");
      default:
        return DatePickerLocaleOptions(monthAlignment: Alignment.centerLeft, monthWidth: 100, yearWidth: 60, dayWidth: 60);
    }
  }
}
